...
public class PlacementStatisticsBean {

	

	private String placmentStatsId;
	...
	public String getPlacmentStatsId() {
		return placmentStatsId;
	}


	public void setPlacmentStatsId(String placmentStatsId) {
