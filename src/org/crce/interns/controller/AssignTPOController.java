...
public class AssignTPOController {
	...
	@RequestMapping(value = "/AdminHome", method = RequestMethod.GET) // Admin
																		// Home
																		// Page
	public ModelAndView goAdminHome(HttpServletRequest request, @ModelAttribute("command") FacultyUserBean userBean,
	...
	@RequestMapping(value = "/FTPCHome", method = RequestMethod.GET) // FTPC
																		// Home
																		// page
	public ModelAndView goFTPCHome(HttpServletRequest request, @ModelAttribute("notify") FacultyUserBean userBean,
			BindingResult result) {
		try {
	...
	@RequestMapping(value = "/ViewUsersA", method = RequestMethod.GET) // View
																		// Users
																		// for
																		// Admin
	...
	@RequestMapping(value = "/ViewUsersF", method = RequestMethod.GET) // View
																		// Users
																		// for
																		// FTPC
	...
	@RequestMapping(value = "/AssignTPCF", method = RequestMethod.GET) // Call
																		// to
																		// jsp
																		// to
																		// get
																		// username
	public ModelAndView assignTPCF(HttpServletRequest request, @ModelAttribute("command") UserDetailsBean userBean,
			BindingResult result) {
		try {
	...
	@RequestMapping(value = "/AssignTPO", method = RequestMethod.GET) // Call to
																		// jsp
																		// to
																		// get
																		// username
	public ModelAndView assignTPO(HttpServletRequest request, @ModelAttribute("command") UserDetailsBean userBean,
			BindingResult result) {
	...
	@RequestMapping(value = "/RemoveTPCF", method = RequestMethod.GET) // Call
																		// to
																		// jsp
																		// to
																		// get
																		// username
	public ModelAndView removeTPCF(HttpServletRequest request, @ModelAttribute("command") UserDetailsBean userBean,
			BindingResult result) {
	...
	@RequestMapping(value = "/RemoveTPO", method = RequestMethod.GET) // Call to
																		// jsp
																		// to
																		// get
																		// username
	public ModelAndView removeTPO(HttpServletRequest request, @ModelAttribute("command") UserDetailsBean userBean,
			BindingResult result) {
	...
	public ModelAndView createUser(HttpServletRequest request, @ModelAttribute("command") UserDetailsBean userBean,
		...
		try {
			...
			} else if (a == 5)// A Non-Faculty user attempted to be assigned as
								// TPO
			{
				model = new ModelAndView("assignTPO");
			...
			} else if (a == 55) { // Already assigned TPO user attempted to be
									// assigned as TPO
				model = new ModelAndView("assignTPO");
	...
	public ModelAndView deleteUser(HttpServletRequest request, @ModelAttribute("command") UserDetailsBean userBean,
			BindingResult bindingResult) {
		...
		try {
			...
			if (a == 0)// No such user exists in UserDetails Table
			{
				...
				model.addObject("erroMesg", erroMesg);
				// return new ModelAndView("noUser");
			} else if (a == 55)// User attempted to be removed as TPO is not a
								// TPO
			{
				model = new ModelAndView("removeTPO");
